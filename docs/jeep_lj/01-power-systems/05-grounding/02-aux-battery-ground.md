...
**Ground Reference to START battery (1/0 AWG):** Critical for BCDC operation - ensures both batteries maintain same ground reference. Handles BCDC charging current (25A) and provides fault current path (75A max). 1/0 AWG rated 325A provides 4.3x safety margin.
