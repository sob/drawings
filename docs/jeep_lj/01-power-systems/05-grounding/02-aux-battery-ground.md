...
| **Ground Reference to Starter Battery** | 1/0 AWG ✓ | 5-6 ft | 75A max | <0.02V | Active |
| **BCDC Alpha 25** | 6 AWG ✓ | Short | 25A | Negligible | Active |
...
**Ground Reference to Starter Battery (1/0 AWG):** Critical for BCDC operation - ensures both batteries maintain same ground reference. Handles BCDC charging current (25A) and provides fault current path (75A max). 1/0 AWG rated 325A provides 4.3x safety margin.

**BCDC Alpha 25 (6 AWG):** Manufacturer specification requires direct connection to battery negative for proper DC-DC charging operation and battery sensing.
...
- [Starter Battery Ground](01-starter-battery-ground.md)
