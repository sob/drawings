...
**Controller:** [Command Touch CT4][# Command Touch CT4 {#command-touch-ct4}] - Steering column-mounted multifunction controller
...
**Power Distribution:** [PMU][# 1.4 - PMU Power Distribution {#pmu-power-distribution}] - Programmable power management
...
### [Tail, Brake & Reverse Lights][# Tail, Brake & Reverse Lights {#tail-brake-reverse-lights}]
...
### [DRL & Parking Lights][# DRL & Parking Lights {#drl-parking-lights}]
...
- [Command Touch CT4][# Command Touch CT4 {#command-touch-ct4}] - Controller specifications and programming
- [PMU Power Distribution][# 1.4 - PMU Power Distribution {#pmu-power-distribution}] - Power management and programming
- [Offroad Lighting][# Offroad & Auxiliary Lighting {#offroad-auxiliary-lighting}] - Auxiliary and offroad lighting circuits
